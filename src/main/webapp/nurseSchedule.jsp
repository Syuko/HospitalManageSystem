    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/NurseWorkServlet?option=showNurseSchedule"> <i class="icon-padnote"></i>排班表 </a></li>
                                    ...
                                    <div class="table-responsive">
                                        <script>
                                            $(document).ready(function(){
                                                var nId = ${nurse.nurseId}
                                                document.getElementById(nId).style="background: mediumpurple;color: white";
                                            });
                                        </script>
