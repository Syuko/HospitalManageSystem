        ...
        <div class="content-inner">
            ...
            <div class="breadcrumb-holder container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">请为病患<strong id="patientId">${patientId}</strong>安排病房</li>
                </ul>
            </div>
                            ...
                            <script>
                                $(document).ready(function(){
                                    ...
                                    $("#dataTables-example").on('click','.btnSelect',function(){
                                        ...
                                        // alert(data);
                                        window.location.href = "${pageContext.request.contextPath}/NurseWorkServlet?option=allotPatientBed&patientId="+patientId+"&bedId="+bedId;
