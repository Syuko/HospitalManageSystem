    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            ...
            <div class="breadcrumb-holder container-fluid">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/NurseWorkServlet?option=showPatientBe">护士工作站</a></li>
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/NurseWorkServlet?option=showPatientBe">选择病人</a></li>
                    <li class="breadcrumb-item active">请为病患<strong id="patientId">${patientId}</strong> (原病房床ID:<strong id="oldBedId">${oldBedId}</strong>)安排病房</li>
                </ul>
            </div>
                            ...
                            <script>
                                $(document).ready(function(){
                                    ...
                                    $("#dataTables-example").on('click','.btnSelect',function(){
                                        ...
                                        var oldBedId = $("#oldBedId").text();
                                        // alert("点到了按钮"+oldBedId);
                                        //获得当前行
                                        var currentRow=$(this).closest("tr");
                                        var bedId=currentRow.find("td:eq(0)").text(); //获得当前行第一个TD值
                                        var buildName=currentRow.find("td:eq(4)").text(); //获得当前行第二个TD值
                                        // var col3=currentRow.find("td:eq(2)").text(); //获得当前行第三个TD值
                                        // alert(data);
                                        window.location.href = "${pageContext.request.contextPath}/NurseWorkServlet?option=resetPatientBed&patientId="+patientId+"&bedId="+bedId+"&oldBedId="+oldBedId+"&buildName="+buildName;
                                ...
                                <div class="card-content">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover text-center"
                                            ...
                                            <c:forEach items="${bedList}" var="b">
                                                <tr class="gradeA">
                                                    <td>${b.bedId}</td>
                                                    <td>${b.bedName}</td>
                                                    <td>${b.home.homeName}</td>
                                                    <td>${b.home.homeType}</td>
                                                    <td>${b.home.build.buildName}</td>
                                                    <td class="center">
                                                        <button type="button"  class="btn btn-primary btnSelect" >安排床位 </button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
