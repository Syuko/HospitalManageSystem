...
<div class="page">
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            ...
            <div class="breadcrumb-holder container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">自定义病房</li>
                    <li class="breadcrumb-item active">自定义病床</li>
                </ul>
            </div>
                            ...
                            <div class="col-lg-12" id="build">
                                <div class="card">
                                    ...
                                    <div class="card-header d-flex align-items-center">
                                        <h3 class="h4">病房ID:<strong id="buildName">${home.homeId}</strong></h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped " >
                                                ...
                                                <c:forEach items="${bedList}" var="bed">
                                                    <tr>
                                                        <th scope="row">${bed.bedId}</th>
                                                        <td>${bed.bedName}</td>
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/NurseWorkServlet?option=deleteBed&bedId=${bed.bedId}&homeId=${bed.home.homeId}"><button class="btn btn-danger">删除</button></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                            ...
                                            <div style="float: right">
                                                ...
                                                <a href="${pageContext.request.contextPath}/NurseWorkServlet?option=deleteHome&homeId=${home.homeId}"><button class="btn btn-danger">删除病房</button></a>
                                                <button class="btn btn-dark " data-toggle="modal" data-target="#homeModal">修改信息</button>
                                                <button class="btn btn-primary test"  data-toggle="modal" data-target="#bedModal">添加病床</button>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">修改病房信息</h4>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="${pageContext.request.contextPath}/NurseWorkServlet?option=changeHome&homeId=${home.homeId}&">
                            <div class="form-group">
                                <label>病房名</label>
                                <input type="text" name="homeName" placeholder="病房名" class="form-control" value="${home.homeName}">
                            </div>
                            <div class="form-group">
                                <label>所属住院楼</label>
                                <input type="text" name="buildName" placeholder="所属住院楼" class="form-control" value="${home.build.buildName}">
                            </div>
                            <div class="form-group">
                                <label>所在楼层</label>
                                <input type="text" name="homeTier" placeholder="所在楼层" class="form-control" value="${home.homeTier}">
                            </div>
                            <div class="form-group">
                                <label>最大病床数</label>
                                <input type="text" name="homeBedNum" placeholder="最大病床数" class="form-control" value="${home.homeBedNum}">
                            </div>
                            <div class="form-group">
                                <label>病房类型</label>
                                <input type="text" name="homeType" placeholder="最大病床数" class="form-control" value="${home.homeType}">
                            </div>
        ...
        <div id="bedModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4  class="modal-title" >向<strong id="addBed"></strong>添加病床</h4>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="${pageContext.request.contextPath}/NurseWorkServlet?option=addBed&homeId=${home.homeId}&">
                            <div class="form-group">
                                <label>病床名</label>
                                <input type="text" name="bedName" placeholder="病床名" class="form-control" id="creatBuildName">
                            </div>
                            <div class="modal-footer">
                                <button type="button" data-dismiss="modal" class="btn btn-secondary">关闭</button>
                                <button type="submit" class="btn btn-primary">提交</button>
