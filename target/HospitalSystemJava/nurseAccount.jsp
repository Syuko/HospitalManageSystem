                                    ...
                                    <table class="table table-striped table-bordered table-hover text-center"
                                        ...
                                        <c:forEach items="${patientList}" var="p">
                                            <tr class="gradeA">
                                                ...
                                                <td class="center">
                                                    <a href="${pageContext.request.contextPath}/NurseWorkServlet?option=showPatientAccount&patientId=${p.patientId}"><button type="button" data-toggle="modal"  class="btn btn-primary" >账单明细 </button></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
